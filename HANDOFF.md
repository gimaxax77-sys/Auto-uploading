...
- **YouTube**: OAuth "프로덕션"(만료 없음) + force-ssl 스코프 → 클로드가 공개↔비공개 전환·삭제 가능. **2026-07-26 기준 공개 95편 / 185편**(남은 90편).
...
2. **새 니치 콘텐츠** — Gim 요청 시 대본 생성(사실기반, 다큐 시리즈는 웅장 무드). 번호는 186부터 이어서. 남은 90편이 약 7~8일 뒤 소진되므로 그 전에 보충 필요.
